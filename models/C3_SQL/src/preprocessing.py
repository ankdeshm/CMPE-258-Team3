...
def parse_option():
    ...
    parser.add_argument('--table_path', type=str, default="/content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/tables.json")
    parser.add_argument('--input_dataset_path', type=str, default="/content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/train_spider.json",
                        help='''
                            options:
                                /content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/train_spider.json
                                /content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/dev.json
                            ''')
    parser.add_argument('--natsql_dataset_path', type=str, default="./NatSQL/NatSQLv1_6/train_spider-natsql.json",
                        help='''
                            ...
                            ''')
    parser.add_argument('--output_dataset_path', type=str, default="/content/drive/MyDrive/CMPE_258/C3SQL-master/data/pre-processing/preprocessed_dataset.json",
                        help="the filepath of preprocessed dataset.")
    parser.add_argument('--db_path', type=str, default="/content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/database", 
    ...
    # print(f"opt.db_path: {opt.db_path}")
    return opt
...
def get_db_contents(question, table_name_original, column_names_original, db_id, db_path):
    ...
    for column_name_original in column_names_original:
        matches = get_database_matches(
            ...
            # db_path = "/content/drive/MyDrive/CMPE_258/C3SQL-master/data/spider/database/concert_singer/concert_singer.sqlite"
