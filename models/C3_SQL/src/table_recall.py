...
openai.api_key = "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"


def parse_option():
    parser = argparse.ArgumentParser("command line arguments for recall tables")
    parser.add_argument("--input_dataset_path", type=str, default='/content/drive/MyDrive/CMPE_258/C3SQL-master/generate_datasets/preprocessed_test.json')
