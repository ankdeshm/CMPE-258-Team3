...
def prepare_batch_inputs_and_labels(batch, tokenizer):
    ...
    dprint(f'tokenized_inputs["input_ids"].shape {tokenized_inputs["input_ids"].shape}', "3.7")
    ...
    for batch_id in range(batch_size):
        ...
        dprint(f'word_ids {word_ids}', "3.7")
        dprint(f'batch_input_tokens[batch_id] {batch_input_tokens[batch_id]}', "3.7")
        ...
        dprint(f"aligned_table_labels: {aligned_table_labels}", "3.7")
        # align column names
